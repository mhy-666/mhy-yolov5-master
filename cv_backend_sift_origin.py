...
img1=cv2.imread(r'M:\pycharmProjects\mhy-yolov5-master\ouputImage-Panorama-Stitching\test2\jiading_1.png')
img2=cv2.imread(r'M:\pycharmProjects\mhy-yolov5-master\ouputImage-Panorama-Stitching\test2\jiading_2.png')
get_sift_image(img2,img1)
